...
- Baked-in CLIs include gh, wrangler, turso, agent-browser, Bitwarden Secrets Manager (`bws`), PostgreSQL client (`pg_dumpall`, `pg_dump`, `psql`), zip/unzip, nano, and Python packages faster-whisper and exa-py.
